<!-- Space: Projects -->
<!-- Parent: ZshGhostty -->
<!-- Title: Contributing GithubFlow ZshGhostty -->
<!-- Label: ZshGhostty -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-ghostty project on [GitHub](https://github.com/hadenlabs/zsh-ghostty), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-ghostty/pulls).
...
To follow the instructions in this guide and start contributing to zsh-ghostty project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-ghostty.git
```

Now your **upstream** points to **hadenlabs/zsh-ghostty**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-ghostty
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-ghostty/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
